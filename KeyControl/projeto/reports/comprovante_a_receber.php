...
$html = '
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <p><strong>' . htmlspecialchars($lanreceber['nome_fantasia']) . '</strong></p>
        ...
        <div class="content">
            <table>
                <tr>
                    <th>Nº Lançamento</th>
                    <td>' . htmlspecialchars($lanreceber['id_lancamento']) . '</td>
                </tr>
                <tr>
                    <th>Tipo de Lançamento</th>
                    <td>' . htmlspecialchars($lanreceber['tipo_lancamento']) . '</td>
                </tr>
                <tr>
                    <th>Registro do Imóvel</th>
                    <td>' . htmlspecialchars($lanreceber['registro_imovel']) . '</td>
                </tr>
                <tr>
                    <th>Data Emissão</th>
