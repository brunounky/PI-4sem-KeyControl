...
<body>
   ...
   <section id="lancamentos">
      ...
      <div class="container">
         ...
         <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a class="button_adicionarnovo floating dropdown-toggle hide-arrow" data-bs-toggle="dropdown"
               aria-expanded="false" href="#">
               <span class="button_adicionarnovo">Adicionar novo +</span>
            </a>
            <ul class="dropdown-menu pull-right">
               <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalFormulario"
                     data-tipo="Aluguel">Aluguel</a></li>
               <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalFormulario"
                     data-tipo="IPTU">IPTU</a></li>
               <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalFormulario"
                     data-tipo="Água">Água</a></li>
               <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#modalFormulario"
                     data-tipo="Reparos">Reparos</a></li>
            </ul>
         </div>
   ...
   <script>
      function redirectToImpressao(id_lancamento) {
         window.open('../reports/impressao_a_receber.php?id=' + id_lancamento, '_blank');
      }

      function redirectToComprovante(id_lancamento) {
         window.open('../reports/comprovante_a_receber.php?id=' + id_lancamento, '_blank');
      }
   </script>
