...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'cadastrar_imovel') {
    ...
    $stmt = $pdo->prepare("INSERT INTO imoveis (cnpj_proprietario, tipo_imovel, quantidade_quartos, quantidade_banheiros, quantidade_vagas, area_total, cep, rua, numero, bairro, cidade, estado, pais, numero_registro_imovel, numero_registro_agua, valor_aluguel, taxa_aluguel, valor_venda, taxa_venda, complemento) 
