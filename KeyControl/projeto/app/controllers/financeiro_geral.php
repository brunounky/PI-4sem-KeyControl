...
function buildQuery($id_lancamento, $tipo_lancamento, $registro_imovel, $data_emissao, $data_vencimento, $valor_total, $forma_pagamento, $data_vigencia, $liquidado, $limit = 10) {
    $sql = "SELECT * FROM lancamento_financeiro WHERE valor_total";
    $params = [];
    ...
    // Adicionando o LIMIT diretamente na consulta
    $sql .= " ORDER BY id_lancamento DESC LIMIT $limit";
...
list($sql, $params) = buildQuery($id_lancamento, $tipo_lancamento, $registro_imovel, $data_emissao, $data_vencimento, $valor_total, $forma_pagamento, $data_vigencia, $liquidado, $resultsPerPage);
